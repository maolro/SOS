...
public class PagePrestamo {
    private PrestamoList _embedded;
    private PageLinks _links;
    private PageMetadata page;

    public PagePrestamo() {}

    public PagePrestamo(PrestamoList _embedded, PageLinks _links, 
    PageMetadata page) {
    ...
    public PrestamoList get_embedded() {
        return _embedded;
    }

    public void set_embedded(PrestamoList _embedded) {
        this._embedded = _embedded;
    }
    ...
    public void imprimirPaginaPrestamos(){
        System.out.println("Total de prestamos: " + page.getTotalElements());
        ...
        if(_embedded != null){
            for (Prestamo prestamo : _embedded.getPrestamoList()) {

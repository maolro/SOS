...
public class GetBookResponse
    ...
    protected es.upm.etsiinf.sos.model.xsd.Book local_return;
     ...
     * 
     * @return es.upm.etsiinf.sos.model.xsd.Book
     */
    public es.upm.etsiinf.sos.model.xsd.Book get_return() {
        return local_return;
    }
     ...
     * @param param _return
     */
    public void set_return(es.upm.etsiinf.sos.model.xsd.Book param) {
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getBookResponse".equals(type)) {
                            ...
                            return (GetBookResponse) es.upm.etsiinf.sos.model.xsd.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://sos.etsiinf.upm.es", "return")
                    ...
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        ...
                        object.set_return(es.upm.etsiinf.sos.model.xsd.Book.Factory.parse(reader));

...
public class Prestamo {
    ...
    public Prestamo(UsuarioResp usuario, Libro libro, Date fechaPrestamo) {
    ...
    public UsuarioResp getUsuario() { return usuario; }

    public void setUsuario(UsuarioResp usuario) { this.usuario = usuario; }
